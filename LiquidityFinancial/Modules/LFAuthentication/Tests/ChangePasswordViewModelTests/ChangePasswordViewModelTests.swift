...
// Test cases for ChangePasswordViewModel
@MainActor
final class ChangePasswordViewModelTests: XCTestCase {
  ...
  func test_isLenghtCorrect_withShortString_shouldFail() {
    ...
    viewModel.newPasswordString = "Short"
  ...
  func test_isLenghtCorrect_withLongString_shouldSucceed() {
    ...
    viewModel.newPasswordString = "ValidPasswordLength"
    // When observing the password input
  ...
  func test_containsSpecialCharacters_withoutSpecialChars_shouldFail() {
    ...
    viewModel.newPasswordString = "PasswordWithoutSpecialChars"
    // When observing the password input
  ...
  func test_containsSpecialCharacters_withSpecialChars_shouldSucceed() {
    ...
    viewModel.newPasswordString = "@PasswordWithSpecialChars@"
    // When observing the password input
    // Then the containsSpecialCharacters var should be equal to false
  ...
  func test_containsLowerAndUpperCase_withOnlyLowerCase_shouldFail() {
    ...
    viewModel.newPasswordString = "lowercasepassword"
    // When observing the password input
  ...
  func test_containsLowerAndUpperCase_withOnlyUpperCase_shouldFail() {
    ...
    viewModel.newPasswordString = "UPPERCASEPASSWORD"
    // When observing the password input
    // Then the containsLowerAndUpperCase var should be equal to false
    expect(self.viewModel.containsLowerAndUpperCase).to(beFalse())
  }
  ...
  func test_containsLowerAndUpperCase_withBothLowerAndUpperCase_shouldSucceed() {
    ...
    viewModel.newPasswordString = "lowerAndUpperCasePassword"
    // When observing the password input
    // Then the containsLowerAndUpperCase var should be equal to true
    expect(self.viewModel.containsLowerAndUpperCase).to(beTrue())
  }
  
  // Testing password validation when all contitions are met but the old password is empty
  func test_isContinueEnabled_withValidNewInputButEmptyOld_shouldSucceed() {
    // Given the new password string which meets all conditions
    viewModel.newPasswordString = "CorrectPassword$"
    // And the old password sring is empty
    viewModel.oldPasswordString = ""
    // When observing the password input and validation
    // Then the isContinueEnabled var should be equal to false (Continue button is not active)
  ...
  func test_isContinueEnabled_withValidInput_shouldSucceed() {
    // Given the new password string which meets all conditions
    viewModel.newPasswordString = "CorrectPassword$"
    // And the old password sring is not empty
    viewModel.oldPasswordString = "NotEmpty"
    // When observing the password input and validation
