...
public struct FeatureFlagsGroup<First: LFFeatureFlagType, Second: LFFeatureFlagType>: LFFeatureFlagType where First.Value == Second.Value {
...
private struct FeatureFlagsGroupDetailView<First: LFFeatureFlagType, Second: LFFeatureFlagType>: View where First.Value == Second.Value {
...
extension LFFeatureFlagType {
  public static func group<First: LFFeatureFlagType, Second: LFFeatureFlagType>(
