...
public protocol RainCardAPIProtocol {
  ...
  func getCardOrders() async throws -> [APIRainCard]
  func orderPhysicalCard(parameters: APIRainOrderCardParameters) async throws -> APIRainCard
  func orderPhysicalCardWithApproval(parameters: APIRainOrderCardParameters) async throws -> APIRainCard
  ...
  func cancelOrder(cardID: String) async throws -> APIRainCard
