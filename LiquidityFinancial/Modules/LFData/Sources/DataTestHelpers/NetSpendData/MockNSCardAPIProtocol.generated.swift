...
public class MockNSCardAPIProtocol: NSCardAPIProtocol {
    ...
    public var verifyCVVCodeVerifyRequestCardIDSessionIDReceivedArguments: (verifyRequest: VerifyCVVCodeParameters, cardID: String, sessionID: String)?
    public var verifyCVVCodeVerifyRequestCardIDSessionIDReceivedInvocations: [(verifyRequest: VerifyCVVCodeParameters, cardID: String, sessionID: String)] = []
    public var verifyCVVCodeVerifyRequestCardIDSessionIDReturnValue: APIVerifyCVVCode!
    public var verifyCVVCodeVerifyRequestCardIDSessionIDClosure: ((VerifyCVVCodeParameters, String, String) async throws -> APIVerifyCVVCode)?
    ...
    public var getApplePayTokenSessionIdCardIdReturnValue: APIGetApplePayToken!
    public var getApplePayTokenSessionIdCardIdClosure: ((String, String) async throws -> APIGetApplePayToken)?
    ...
    public var postApplePayTokenSessionIdCardIdBodyDataReturnValue: APIPostApplePayToken!
    public var postApplePayTokenSessionIdCardIdBodyDataClosure: ((String, String, [String: Any]) async throws -> APIPostApplePayToken)?
