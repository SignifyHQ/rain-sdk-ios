...
struct SolidApplePayViewController: UIViewControllerRepresentable {
...
extension SolidApplePayViewController {
  class Coordinator: NSObject, PKAddPaymentPassViewControllerDelegate {
    var parent: SolidApplePayViewController
    
    init(_ parent: SolidApplePayViewController) {
      self.parent = parent
    }
