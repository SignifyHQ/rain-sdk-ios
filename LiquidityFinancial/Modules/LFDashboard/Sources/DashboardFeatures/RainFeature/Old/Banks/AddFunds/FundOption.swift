...
extension FundOption {
  ...
  var image: Image {
    switch self {
    case .directDeposit:
      return GenImages.CommonImages.directDeposit.swiftUIImage
    case .bankTransfers:
      return GenImages.CommonImages.bankTransfers.swiftUIImage
    case .debitDeposit, .debitDepositFunds:
      return GenImages.CommonImages.debitDeposit.swiftUIImage
    case .oneTime:
      return GenImages.CommonImages.oneTime.swiftUIImage
    }
  }
