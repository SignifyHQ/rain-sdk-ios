...
struct NSApplePayViewController: UIViewControllerRepresentable {
  @Environment(\.presentationMode) var presentation
  @StateObject private var viewModel: NSApplePayViewModel
  
  var onSuccess: (() -> Void)?
  
  init(viewModel: NSApplePayViewModel, onSuccess: ( () -> Void)? = nil) {
...
extension NSApplePayViewController {
  class Coordinator: NSObject, PKAddPaymentPassViewControllerDelegate {
    var parent: NSApplePayViewController
    
    init(_ parent: NSApplePayViewController) {
      self.parent = parent
    }
