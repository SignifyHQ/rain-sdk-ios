...
//        }
        ...
        section(title: "Saved wallet addresses") {
          ArrowButton(
            image: GenImages.CommonImages.icAssets.swiftUIImage,
            title: "Saved wallet addresses",
            value: nil
          ) {
            viewModel.navigation = .savedWalletAddresses
          }
        }
...
//  }
  ...
  var walletBackupSection: some View {
    section(title: L10N.Common.AccountView.WalletBackup.section) {
      ArrowButton(
        image: GenImages.CommonImages.legal.swiftUIImage,
...
//      }
      if !viewModel.notificationsEnabled {
        ArrowButton(
          image: GenImages.CommonImages.notifications.swiftUIImage,
