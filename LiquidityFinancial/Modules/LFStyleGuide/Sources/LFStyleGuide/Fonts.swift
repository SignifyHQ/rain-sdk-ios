...
public enum Fonts {
  ...
  public static var black: FontConvertible {
    ...
    case .DogeCard, .DogeCardNobank, .CauseCard, .CauseCardNetspend, .PrideCard: return Lato.black
  ...
  public static var bold: FontConvertible {
    ...
    case .DogeCard, .DogeCardNobank, .CauseCard, .CauseCardNetspend, .PrideCard: return Lato.bold
  ...
  public static var extraLight: FontConvertible {
    ...
    case .DogeCard, .DogeCardNobank, .CauseCard, .CauseCardNetspend, .PrideCard: return Lato.light
  ...
  public static var medium: FontConvertible {
    ...
    case .DogeCard, .DogeCardNobank, .CauseCard, .CauseCardNetspend, .PrideCard: return Lato.medium
  ...
  public static var regular: FontConvertible {
    ...
    case .DogeCard, .DogeCardNobank, .CauseCard, .CauseCardNetspend, .PrideCard: return Lato.regular
