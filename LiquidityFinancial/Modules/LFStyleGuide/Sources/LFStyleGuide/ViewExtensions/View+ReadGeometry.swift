...
public extension View {
  ...
  func readGeometry(perform action: @escaping (GeometryProxy) -> Void) -> some View {
    background(
  ...
  func readGeometryChange(perform action: @escaping (GeometryProxy) -> Void) -> some View {
    background(
