...
public extension View {
  ...
  @ViewBuilder
  func applyIf<Modifier: ViewModifier>(_ condition: Bool, @ViewBuilder modifier: () -> Modifier) -> some View {
    if condition {
  ...
  ///   is `true`.
  @ViewBuilder
  func applyIf<Content: View>(_ condition: Binding<Bool>, @ViewBuilder transform: (Self) -> Content) -> some View {
  ...
  @ViewBuilder
  func apply<Content: View, Item: Hashable>(item: Item?, @ViewBuilder transform: (Item?, Self) -> Content) -> some View {
    transform(item, self)
  }
  
  /// Applies the given transform considering a Bool value.
  @ViewBuilder
  func apply<Content: View>(condition: Bool, @ViewBuilder transform: (Bool, Self) -> Content) -> some View {
