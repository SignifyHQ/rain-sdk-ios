...
public enum Colors {
  ...
  public enum Gradients {
    public enum Angular {
      public static let gradientAngular0 = ColorAsset(name: "gradientAngular0")
      public static let gradientAngular1 = ColorAsset(name: "gradientAngular1")
    }
    public enum Button {
  ...
  public static let donationCardBackground = ColorAsset(name: "donationCardBackground")
  ...
  public static let virtualCardBackground = ColorAsset(name: "virtualCardBackground")
