...
public enum GenImages {
  public enum CommonImages {
    public enum Accounts {
      ...
      public static let icDispute = ImageAsset(name: "ic_dispute")
    ...
    public static let icAvaxFilled = ImageAsset(name: "ic_avax_filled")
    public static let icBack = ImageAsset(name: "ic_back")
    public static let icCardano = ImageAsset(name: "ic_cardano")
    public static let icCardanoFilled = ImageAsset(name: "ic_cardano_filled")
    ...
    public static let icHomeCards = ImageAsset(name: "ic_homeCards")
    ...
    public static let icPasswordHide = ImageAsset(name: "ic_password_hide")
    public static let icPasswordShow = ImageAsset(name: "ic_password_show")
    ...
    public static let icRoundUpDonationLeft = ImageAsset(name: "ic_round_up_donation_left")
    public static let icRoutingNumber = ImageAsset(name: "ic_routing Number")
    public static let icSearch = ImageAsset(name: "ic_search")
    public static let icSecurity = ImageAsset(name: "ic_security")
  ...
  public enum Images {
    ...
    public static let icContrastLogo = ImageAsset(name: "ic_contrast_logo")
    ...
    public static let icPause = ImageAsset(name: "ic_pause")
