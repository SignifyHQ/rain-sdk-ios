...
public class MockZerohashAccountRepositoryProtocol: ZerohashAccountRepositoryProtocol {
    ...
    public var getAccountsReturnValue: [ZerohashAccountEntity]!
    public var getAccountsClosure: (() async throws -> [ZerohashAccountEntity])?
    ...
    public var getAccountDetailIdReturnValue: ZerohashAccountEntity!
    public var getAccountDetailIdClosure: ((String) async throws -> ZerohashAccountEntity)?
