...
extension DBCache.Entry: Codable where Key: Codable, Value: Codable {}

extension DBCache: Codable where Key: Codable, Value: Codable {
...
final class DBCache<Key: Hashable, Value> {
