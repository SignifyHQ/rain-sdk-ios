...
public struct DogeCardWelcomeView: View {
  
  @StateObject var viewModel = DogeCardWelcomeViewModel()
  ...
  private var staticTop: some View {
    VStack(spacing: 12) {
      Image("wellcome_header", bundle: .module)
        .resizable()
        .scaledToFit()
...
#if DEBUG
struct DogeCardWelcomeView_Previews: PreviewProvider {
  static var previews: some View {
    NavigationView(content: {
      DogeCardWelcomeView(destination: AnyView(Text("Xin chao")))
    })
