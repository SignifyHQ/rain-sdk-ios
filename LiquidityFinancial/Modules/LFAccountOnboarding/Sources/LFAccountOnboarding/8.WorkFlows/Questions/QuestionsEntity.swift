...
public class QuestionsEntity {
  ...
  class AnswerOptions: Equatable, Hashable {
    static func == (lhs: QuestionsEntity.AnswerOptions, rhs: QuestionsEntity.AnswerOptions) -> Bool {
  ...
  public static var mockKYCQuestion = QuestionsEntity(
    questions: [
      AnswerOptions(id: "340b1782-4c49-4697-bde1-d84f9dc159d5", question: "From whom did you purchase the property at 222333 PEACHTREE PLACE?", answer: [
        Answer(isSelect: false, answerId: "9a02ebb0-7686-4b96-af09-dd896c856240", text: "CHRIS THOMAS"),
      ...
      AnswerOptions(id: "5f6f67b6-8df8-40d6-85ec-1ecc5702ef46", question: "At which of the following addresses have you lived?", answer: [
        Answer(isSelect: false, answerId: "b130ac68-a4ab-4682-ace3-26f000cc0e3a", text: "1084 BPEACHTREE CT"),
      ...
      AnswerOptions(id: "d3f86196-59f3-4b00-a188-e62c2ee05068", question: "What type of residence is 222333 PEACHTREE PLACE?", answer: [
        Answer(isSelect: false, answerId: "ad500453-c1ea-420b-9f05-c3b61ff07b52", text: "Townhome"),
